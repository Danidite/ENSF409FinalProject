...
public class setUpDatabase implements IDBCredentials {
	...
	public static void main(String[] args) {
		...
		myApp.insertCourse(7, "Math", 277);
		myApp.insertCourseOffering(13, "Math", 277, 1, 30);
		myApp.insertCourseOffering(14, "Math", 277, 2, 31);
		
		myApp.insertCourse(8, "Spe", 121);
		myApp.insertCourseOffering(15, "Spe", 121, 1, 3);
		myApp.insertCourseOffering(16, "Spe", 121, 2, 2);
		myApp.insertCourseOffering(17, "Spe", 121, 3, 1);
		myApp.insertCourseOffering(18, "Spe", 121, 4, 0);
		
		myApp.createAccount(1, "admin", "1234");
		myApp.createAccount(0, "user", "password");
